...
import jrItext from "vellum/javaRosa/itext";
import jr from "vellum/javaRosa/util";
import vellumUtil from "vellum/util";
import BARE_OUTPUT from "static/javaRosa/bare-output.xml";
import OUTPUTREF_GROUP_RENAME_XML from "static/javaRosa/outputref-group-rename.xml";
import TEXT_QUESTION_XML from "static/javaRosa/text-question.xml";
import MULTI_LANG_TRANS_XML from "static/javaRosa/multi-lang-trans.xml";
import MULTI_LINE_TRANS_XML from "static/javaRosa/multi-line-trans.xml";
import OUTPUT_REFS_XML from "static/javaRosa/output-refs.xml";
import OUTPUTREF_WITH_INEQUALITY_XML from "static/javaRosa/outputref-with-inequality.xml";
import GROUP_WITH_CONSTRAINT_XML from "static/javaRosa/group-with-constraint.xml";
import TEXT_WITH_CONSTRAINT_XML from "static/javaRosa/text-with-constraint.xml";
import ITEXT_ITEM_RENAME_XML from "static/javaRosa/itext-item-rename.xml";
import ITEXT_ITEM_RENAME_GROUP_MOVE_XML from "static/javaRosa/itext-item-rename-group-move.xml";
import ITEXT_ITEM_NON_AUTO_ID_XML from "static/javaRosa/itext-item-non-auto-id.xml";
import SELECT1_HELP_XML from "static/javaRosa/select1-help.xml";
import SINGLE_LANG_SELECT_XML from "static/javaRosa/single-lang-select.xml";
import SINGLE_LANG_SECOND_SELECT_WITH_HELP_XML from "static/javaRosa/single-lang-second-select-with-help.xml";
import NO_LABEL_TEXT_ONE_LANG_XML from "static/javaRosa/no-label-text-one-lang.xml";
import TEST_XML_1 from "static/javaRosa/test-xml-1.xml";
import TEST_XML_2 from "static/javaRosa/test-xml-2.xml";
import TEST_XML_2_WITH_BIND_CONSTRAINT from "static/javaRosa/test-xml-2-with-bind-constraint.xml";
import TEST_XML_2_WITH_ONLY_BIND_CONSTRAINT from "static/javaRosa/test-xml-2-with-only-bind-constraint.xml";
import TEST_XML_3 from "static/javaRosa/test-xml-3.xml";
import TEST_XML_4 from "static/javaRosa/test-xml-4.xml";
import NON_DEFAULT_LANG_FIRST_XML from "static/javaRosa/non-default-lang-first.xml";
import INVALID_OUTPUT_REF_XML from "static/javaRosa/invalid-output-ref.xml";
