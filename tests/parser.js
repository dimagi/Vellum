...
import LABEL_WITHOUT_ITEXT_XML from "static/parser/label-without-itext.xml";
import MISSING_BIND_XML from "static/parser/missing-bind.xml";
import TEST_XML_1 from "static/parser/test-xml-1.xml";
import TEST_XML_2 from "static/parser/test-xml-2.xml";
import OVERRIDE_XML from "static/parser/override.xml";
import OVERRIDDEN_XML from "static/parser/overridden.xml";
import FIRST_TIME_HASHTAG_XML from "static/parser/first-time-hashtag.xml";
import REPEAT_WITH_COUNT_AS_QUESTION_ONLY_FORM_XML from "static/parser/repeat-with-count-as-question-only-form.xml";
import REPEAT_WITH_COUNT_AS_QUESTION_XML from "static/writer/repeat-with-count-as-question.xml";
