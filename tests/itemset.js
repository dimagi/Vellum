...
import datasources from "vellum/datasources";
import itemset from "vellum/itemset";
import form from "vellum/form";
import TEST_XML_1 from "static/itemset/test1.xml";
import TEST_XML_1_WITH_CONSTRAINT from "static/itemset/test1-with-constraint.xml";
import TEST_XML_1_WITH_APPEARANCE from "static/itemset/test1-with-appearance.xml";
import INNER_FILTERS_XML from "static/itemset/inner-filters.xml";
import ITEMSET_SORT_XML from "static/itemset/itemset-sort.xml";
import DROPDOWN_FIXTURE_XML from "static/itemset/dropdown-fixture.xml";
import DATA_ITEMSET_XML from "static/itemset/data-itemset.xml";
import FILTER_WITH_CASE_PROPERTY from "static/itemset/filter-with-case-property.xml";
import ITEMSET_WITH_QUESTION_REF_XML from "static/itemset/itemset-with-question-ref.xml";
