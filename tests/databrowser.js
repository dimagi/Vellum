...
import databrowser from "vellum/databrowser";
import CHILD_REF_XML from "static/databrowser/child-ref.xml";
import CHILD_REF_NO_HASHTAG_XML from "static/databrowser/child-ref-no-hashtag.xml";
import MOTHER_REF_XML from "static/databrowser/mother-ref.xml";
import CHILD_REF_OUTPUT_VALUE_XML from "static/databrowser/child-ref-output-value.xml";
import CHILD_REF_OUTPUT_VALUE_OTHER_LANG_XML from "static/databrowser/child-ref-output-value-other-lang.xml";
import IGNORE_RICH_TEXT from "static/databrowser/ignore-rich-text.xml";
import PRELOADED_HASHTAGS_XML from "static/databrowser/preloaded-hashtags.xml";
import UNKNOWN_PROPERTY_PRELOADED_HASHTAGS_XML from "static/databrowser/unknown-property-preloaded-hashtags.xml";
