define([
    ...
    var intentManager = function () {
        ...
        that.writeIntentXML = function (xmlWriter, controlTree) {
            ...
            intents = controlTree.treeMap(getIntentMugs);
            if (intents.length > 0) {
    ...
    $.vellum.plugin("intents", {}, {
        ...
        contributeToHeadXML: function (xmlWriter, form) {
            this.__callOld();
            this.data.intents.manager.writeIntentXML(xmlWriter, form.controlTree);
        },
