...
import debug from "vellum/debugutil";
import diff_match_patch from "diff-match-patch";
import CryptoJS from "crypto-js";
import "vellum/jstree-plugins";
import "vellum/less-style/main.less";
import "jstree";
import "jstree-actions";
import "jstree-styles";
import "bootstrap";
import "Caret.js";
import "at.js";
...
setTimeout(function () {
    import('codemirror').then(() => {
        ...
        import('vellum/expressionEditor');
    });
}, 0);
...
fn.showSourceXMLModal = function (done) {
    ...
    // Move require code mirrow to top-level import
...
fn.displayXPathEditor = function(options) {
    ...
    options.loadEditor = function($div, options) {
        import('vellum/expressionEditor').then((module) => {
            module.default.showXPathEditor($div, options);
        });
    };
