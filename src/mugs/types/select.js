...
const Choice = util.extend(defaultOptions, {
    isControlOnly: true,
...
const BaseSelect = util.extend(defaultOptions, {
...
const MSelect = util.extend(BaseSelect, {
...
const Select = util.extend(BaseSelect, {
