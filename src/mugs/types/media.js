...
const AudioField = util.extend(defaultOptions, {
...
const ImageField = util.extend(AudioField, {
...
const Video = util.extend(AudioField, {
    typeName: gettext('Video Capture'),
    icon: 'fa fa-video-camera',
    mediaType: "video/*",
});

const Signature = util.extend(ImageField, {
...
const DocumentField = util.extend(AudioField, {
