...
import $ from "jquery";
import date_format_popover from "vellum/templates/date_format_popover.html";
import easy_reference_popover from "vellum/templates/easy_reference_popover.html";
...
var editor = function(input, form, options) {
    ...
    var getWidget = widgets.util.getWidget;
...
function createPopover(element) {
    var $element = $(element),
        ...
        widget = widgets.util.getWidget($widget);
    if (widget) {
